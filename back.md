...
```json
{
  ...
  "data": {
    ...
    "appointment_id": 1,
    "attended": true,
    "marked_at": "2026-01-25T10:05:00.000000Z"
  }
}
```
...
- El estudiante no debe tener deuda
...
{
  "status": "error",
  "message": "El estudiante tiene deuda pendiente",
  "errors": []
}
```
...
- Puede haber multa por cancelación tardía
